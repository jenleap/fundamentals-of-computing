...
class Ship:
    ...
    def update_thruster(self, thrust):
        self.thrust = thrust
        if thrust:
    ...
    def shoot(self):
        global a_missile
        a_missile = Sprite(self.pos, angle_to_vector(self.angle), self.angle, 0, missile_image, missile_info, missile_sound)
...
a_missile = Sprite([WIDTH / 2, HEIGHT / 2], [1, 0], 0, 0, missile_image, missile_info, missile_sound)
